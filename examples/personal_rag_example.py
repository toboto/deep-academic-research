...
def main(query: str, output_file: str, verbose: bool = False, max_articles: int = 50, recent_months: int = 24):
    """
...
if __name__ == "__main__":
    ...
    parser.add_argument('--recent-months', '-r', type=int, default=24, help='最近几个月的文章优先级较高')
    ...
    output_file = args.output if args.output else os.path.join(
        parent_dir, 
        "outputs", 
        f"{researcher}-personal-rag-{timestamp}.md"
    )
